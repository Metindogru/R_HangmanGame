...
class Hangman extends Component {
  ...
  constructor(props) {
    super(props);
    this.state = { nWrong: 0, guessed: new Set(), answer: NewsKey() };
  ...
  render() {
    ...
    if (isWinner) gameState = "Tebrikler! Tekrar denemek ister misin?";
    if (gameOver) gameState = "Üzgünüm! İdam Edildi!";
    return (
